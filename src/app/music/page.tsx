        ...
        <main className={styles.main}>
          ...
          <section className={styles.content}>
            ...
            <div className={styles.contentAllMusic}>
              ...
              <div>
                <p>
                  A shared release with Atlanta sludge outfit Leechmilk,
                  brokered through Tee Pee Records, that put SKK on the radar of
                  the wider underground heavy scene. The release kicked off a
                  string of east coast tours alongside Fistula, with shows
                  shared among Beaten Back to Pure, Slow Horse, Molehill,
                  Mugwart, and Weedeater.
                </p>
                <p className={styles.moreInfo}>
          ...
          <section className={styles.content}>
            ...
            <div className={styles.contentAllMusic}>
              <div>
                <Link href="/music/lust-crime-and-holiness/">
                  <Image
              ...
              <div>
                <p>
                  A four-track EP that sharpened the band's sound and introduced
                  a wider audience to the SKK formula: crushing riffs, blunt
          ...
          <section className={styles.content}>
            ...
            <div className={styles.contentAllMusic}>
              <div>
                <Link href="/music/midnight-magic/">
                  <Image
              ...
              <div>
                <p>
                  SKK's first full-length and their definitive statement.
                  Released on Retribute Records and supported by a lengthy west
                  coast tour booked through Thunderdome Booking Agency, Midnight
                  Magic saw the band open for sludge metal pioneers 16 — one of
                  their most significant runs on the road. The record pushed
                  deeper into blues territory without losing any of the
                  heaviness, warm in production and hard-hitting in every track.
                  It would be their last west coast tour; SKK returned to local
                  and regional shows until the band came to an end in 2009.
                </p>
                <p className={styles.moreInfo}>
